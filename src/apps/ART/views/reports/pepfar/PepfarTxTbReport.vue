    ...
    data: () => ({
        ...
        columns: [
            [       
                ...
                table.thTxt('Gender'),
                table.thTxt('TX_CURR'),
                table.thTxt('Sceen Pos_New on ART'),
                table.thTxt('Sceen Neg_New on ART'),
                table.thTxt('Sceen Pos_Prev on ART'),
                table.thTxt('Sceen Neg_Prev on ART'),
    ...
    methods: {
        ...
        async setAggregatedRows() {
            ...
            this.rows.push([
                ...
                male('sceen_pos_new', 'Sceen pos new'),
                male('sceen_neg_new', 'Sceen neg new'),
                male('sceen_pos_prev', 'Sceen positive prev'),
                male('sceen_neg_prev', 'Sceen negative prev'),
            ...
            this.rows.push([
                ...
                fp('sceen_pos_new', 'FP', 'Sceen pos new'),
                fp('sceen_neg_new', 'FP', 'Sceen neg new'),
                fp('sceen_pos_prev', 'FP', 'Sceen positive prev'),
                fp('sceen_neg_prev', 'FP', 'Sceen negative prev'),
            ...
            this.rows.push([
                ...
                table.td('FNP'),
                fnp('tx_curr', 'TX Curr'),
                fnp('sceen_pos_new', 'Sceen pos new'),
                fnp('sceen_neg_new', 'Sceen neg new'),
                fnp('sceen_pos_prev', 'Sceen positive prev'),
                fnp('sceen_neg_prev', 'Sceen negative prev'),
            ...
            this.rows.push([
                ...
                fp('sceen_pos_new', 'FBf', 'Sceen pos new'),
                fp('sceen_neg_new', 'FBf', 'Sceen neg new'),
                fp('sceen_pos_prev', 'FBf', 'Sceen positive prev'),
                fp('sceen_neg_prev', 'FBf', 'Sceen negative prev'),
        ...
        setRows(gender: 'M' | 'F') {
            ...
            AGE_GROUPS.forEach((ageGroup: string) => {
                this.rows.push([
                    ...
                    drill('sceen_pos_new', ageGroup, 'Sceen pos new'),
                    drill('sceen_neg_new', ageGroup, 'Sceen neg new'),
                    drill('sceen_pos_prev', ageGroup, 'Sceen pos prev'),
                    drill('sceen_neg_prev', ageGroup, 'Sceen neg prev'),
